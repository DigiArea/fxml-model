...
public class ReferenceElement extends ValueElement {
    ...
    ReferenceElement(String source, String fxId, String controller, String prefix, String name, String id, String identifier, List<Attribute> attributes, List<Element> elements) {
